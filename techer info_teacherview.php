...
$statment1="select * from teacher where Login_id='$id'";
...
<br>
<center>
<form action="Teacher info_teacherview.php" method="POST">
...
<tr>
        ...
        <td width=300px><b> <?php echo "<font color='red'>*class Tutor &nbsp;</font>". $rows22['username'] ?></b></td>
        
        <td align=center> <a class="example_d" href="profile teacher_tutorview.php?id=<?php echo $rows22['Login_id']; ?>" rel="nofollow noopener">Profile</a></td>
</tr>
<?php
$count=2;
...
?>
    ...
    <tr>
        ...
        <td align=center> <a class="example_d" href="profile teacher_tutorview.php?id=<?php echo $rows2['Login_id']; ?>" rel="nofollow noopener">Profile</a></td>
