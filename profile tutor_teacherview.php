...
$id=$_REQUEST['id'];;
$query="select * from tutor where Email_id='$id'";
...
<pre align="right"><a href="Teacher info_teacherview.php" ><b><font size="6px" color="Red">Back</font></b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</pre>
...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="imageview_tutor.php?id=<?php echo $rows['Email_id']; ?>" class="img-radius" alt="User-Profile-Image" height=100 width=100>  </div>
                                <h3 class="f-w-600"><?php  echo $rows['Tutor_name'];?></h3>
                                <br> 
                            </div><center>
