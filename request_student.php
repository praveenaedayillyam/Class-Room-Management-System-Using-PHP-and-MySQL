...
<form action="request_student.php" method="post">
...
<div id="id01" class="request">
  ...
  <form class="request-content animate" action="request_student.php" method="post">
...
$st="select * from users where (class1='class' or class2='$class' or class3='$class' or class4='$class' or class5='$class' or class6='$class' or class7='$class' or class8='$class' or class9='$class' or class10='$class') AND class_type='10' order by username";
      ...
      if($sql)
        {
          echo  "<script>
            ...
            window.location.href='request_student.php'
            </script>";
