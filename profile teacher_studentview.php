...
<pre align="right"><a href="Teacher info_studentview.php" ><b><font size="6px" color="Red">Back</font></b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</pre>
...
<div class="card-block text-center text-white">
                    <center><div class="m-b-25"> <img src="imageview_teacher.php?id=<?php echo $rows['Login_id']; ?>" height=100 width=100>  </div>
