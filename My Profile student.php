...
<div class="card-block text-center text-white">
                            ...
                            <center><div class="m-b-25"> <img src="imageview_student_self.php" class="img-radius" alt="" height=100 width=100>  </div>
                                <h3 class="f-w-600"> <?php  echo $rows['Student_name'];?></h3>
                                <br> <button name=btn1 onclick="window.location.href='edit my profile.php'">Edit</button>
                            </div><center>
...
<tr>  <th align=left> <i>Department</i> </th>   <td>:</td>   <td><b> <?php  echo $rows['UG_PG']." ".$rows['Department']." ".$rows['Year_of_Addmission'];?> </b> </td>    </tr>
